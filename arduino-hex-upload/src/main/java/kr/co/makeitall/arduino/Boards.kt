...
enum class Boards(
    ...
    ARDUINO_PRO_5V_328(
        ...
        57600,
        ComProtocols.UART,
        "Arduino Pro or Pro Mini (5V, 16MHz) ATmega328",
        "DTR;true",
        "DTR-RTS;250;50",
        ""
    ),
    ARDUINO_PRO_5V_168(
        ...
        19200,
        ComProtocols.UART,
        "Arduino Pro or Pro Mini (5V, 16MHz) ATmega168",
        "DTR;true",
        "DTR-RTS;250;50",
        ""
    ),
    ...
    ARDUINO_PRO_33V_168(
        ...
        19200,
        ComProtocols.UART,
        "Arduino Pro or Pro Mini (3.3V, 8MHz) ATmega168",
        "DTR;true",
        "DTR-RTS;250;50",
        ""
    ),
