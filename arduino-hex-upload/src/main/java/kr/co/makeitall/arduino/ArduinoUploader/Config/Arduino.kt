...
public class Arduino {
    ...
    private kr.co.makeitall.arduino.ArduinoUploader.Config.Protocol Protocol = getProtocol().values()[0];

    public final kr.co.makeitall.arduino.ArduinoUploader.Config.Protocol getProtocol() {
        return Protocol;
    }

    public final void setProtocol(kr.co.makeitall.arduino.ArduinoUploader.Config.Protocol value) {
        Protocol = value;
    }

    public Arduino(String model, McuIdentifier mcu, int baudRate, String preOpenResetBehavior, String postOpenResetBehavior, String closeResetBehavior, int sleepAfterOpen, int readTimeout, int writeTimeout, kr.co.makeitall.arduino.ArduinoUploader.Config.Protocol protocol) {
        Model = model;
        Mcu = mcu;
        BaudRate = baudRate;
    ...
    public Arduino(String model, McuIdentifier mcu, int baudRate, kr.co.makeitall.arduino.ArduinoUploader.Config.Protocol protocol) {
        Model = model;
        Mcu = mcu;
        BaudRate = baudRate;
        Protocol = protocol;
